...
| RQ-BOARD-01 | Grid side = `board.size` (min 7) | Yes | F-T13#1 | F | 1 | P | T | `board` | `board.size` | ✓ | – | – | tests | NOT-STARTED |
| RQ-BOARD-02 | Exactly 2 agents | Yes | F-T13#2 | F | 1 | P | T | `board` | `board.num_agents` | ✓ | – | – | tests | NOT-STARTED |
| RQ-BOARD-03 | Config identical byte-for-byte both sides | Yes | E-R11 | R | 6 | P | T | `config/loader` | all shared | ✓ | ✓ | – | hash match | NOT-STARTED |
| RQ-MOVE-01 | Orthogonal move + stay; no diagonals | Yes | F-T15#1 / E-R13,14 | F | 1 | P | T | `board/rules` | `movement.set` | ✓ | – | – | tests | NOT-STARTED |
| RQ-MOVE-02 | Barrier quota ≤ `barrier_quota` (police-only action) | Yes | F-T15#2 | F | 1 | **P** | – (validate only) | `board/rules` | `movement.barrier_quota` | ✓ | – | – | tests | NOT-STARTED |
| RQ-MOVE-03 | Barrier placement declared openly; thief validates & reacts | Yes | E-R15,16 | R | 1/6 | **P** | T (verify) | `board/rules` | — | ✓ | ✓ | – | tests | NOT-STARTED |
| RQ-CAP-01 | Capture on coordinate overlap (police wins) | Yes | E-R48 | R | 1 | P | T | `board/rules` | — | ✓ | – | – | tests | NOT-STARTED |
| RQ-CAP-02 | Barrier on thief's cell = capture (thief detects) | Yes | E-R46 | R | 1 | P | **T** | `board/rules` | — | ✓ | – | – | tests | NOT-STARTED |
| RQ-CAP-03 | Thief with no legal move = captured | Yes | E-R47 | R | 1 | P | **T** | `board/rules` | — | ✓ | – | – | tests | NOT-STARTED |
| RQ-WIN-01 | Max steps / survival threshold (min 35) — thief survival win | Yes | F-T15#3,4 | F | 1 | P | **T** | `board/rules` | `movement.max_steps`,`survival_threshold` | ✓ | – | – | tests (see C-002) | NOT-STARTED |
| RQ-SCORE-01 | Scoring 20/5/5/10, tie 2 | Yes | F-T17, E-R48 | F | 1/7 | P | T | `scoring` | `scoring.*` | ✓ | – | – | tests | NOT-STARTED |
...
| RQ-QUAL-02 | Ruff zero violations | Yes | G | G | all | P | T | repo | — | – | – | ✓ | ruff log | NOT-STARTED |
| RQ-QUAL-03 | ≥85% meaningful coverage | Yes | G | G | all | P | T | repo | — | ✓ | ✓ | – | cov report | NOT-STARTED |
| RQ-QUAL-04 | ~≤150 lines/source file unless justified | Yes | G | G | all | P | T | repo | — | – | – | ✓ | review | NOT-STARTED |
